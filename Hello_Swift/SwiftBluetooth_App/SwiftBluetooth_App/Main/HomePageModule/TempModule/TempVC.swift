...
extension TempVC {
    ...
    private func setNavigationBarUI(){
        //设置导航栏右侧的item
        let rightItem = UIBarButtonItem.init(image: UIImage(named: "explain"), style: .plain,target: self, action: nil)
    ...
    private func setBaseScrollViewUI(){
        ...
        let contentSize = CGSize.init(width: UIScreen.main.bounds.size.width, height: UIScreen.main.bounds.size.width * (812.0/375.0))
...
extension TempVC: UIScrollViewDelegate {
