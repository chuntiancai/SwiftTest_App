...
class TestSubVC_SubVC2: UIViewController {

    
    //MARK: 顺序0， 去寻找nib文件：
    override var nibName: String?{
        get{
            print("∆∆ 顺序0，TestSubVC_SubVC2 的nibName属性")
    ...
    override func loadView(){
        super.loadView()
        print("∆∆ 顺序1，TestSubVC_SubVC2 loadView")
    }
    
    //MARK: 顺序2，VC 的view是否被加载进内存了
    override var isViewLoaded: Bool {
        get{
            print("∆∆ 顺序2，TestSubVC_SubVC2 isViewLoaded:\(super.isViewLoaded)")
    ...
    override var parent: UIViewController? {
        get{
            print("∆∆ 顺序3，TestSubVC_SubVC2 parent:\(String(describing: super.parent))")
            return super.parent
        }
    }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("∆∆ 顺序4，TestSubVC_SubVC2 viewDidLoad")
        self.title = "被测试生命周期的VC"
    }
    //MARK: 顺序4，当作为别人儿子时，会调用该方法，询问是不是作为presentedViewController，还是作为儿子
    override var presentedViewController: UIViewController?{
        get{
            print("∆∆ 顺序4，TestSubVC_SubVC2 presentedViewController：\(String(describing: super.presentedViewController))")
...
//        self.view.backgroundColor = .red
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        print("∆∆ TestSubVC_SubVC2 生命周期VC touchesBegan")
    }
   
    
    override func loadViewIfNeeded (){
        super.loadViewIfNeeded()
        print("∆∆ TestSubVC_SubVC2 loadViewIfNeeded")
    }
    override var viewIfLoaded: UIView? {
        get{
            print("∆∆ TestSubVC_SubVC2 viewIfLoaded")
    ...
    override func addChild(_ childController: UIViewController) {
        print("∆∆ TestSubVC_SubVC2 addChild")
        super.addChild(childController)
    }
  
    
    deinit {
        print("∆∆ TestSubVC_SubVC2 销毁了～")
    }
    
    override var nibBundle: Bundle?{
        get{
            print("∆∆ TestSubVC_SubVC2 nibBundle")
    ...
    override var storyboard: UIStoryboard?{
        get{
            print("∆∆ TestSubVC_SubVC2 storyboard")
            return super.storyboard
        }
    }

    override func performSegue(withIdentifier identifier: String, sender: Any?) {
        print("∆∆ TestSubVC_SubVC2 performSegue")
        super.performSegue(withIdentifier: identifier, sender: sender)
    }
    
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        print("∆∆ TestSubVC_SubVC2 shouldPerformSegue")
        return super.shouldPerformSegue(withIdentifier: identifier, sender: sender)
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        print("∆∆ TestSubVC_SubVC2 prepare")
        super.prepare(for: segue, sender: sender)
    }

    override func canPerformUnwindSegueAction(_ action: Selector, from fromViewController: UIViewController, sender: Any?) -> Bool {
        if #available(iOS 13.0, *) {
            print("∆∆ TestSubVC_SubVC2 canPerformUnwindSegueAction")
    ...
    override func allowedChildrenForUnwinding(from source: UIStoryboardUnwindSegueSource) -> [UIViewController] {
        print("∆∆ TestSubVC_SubVC2 allowedChildrenForUnwinding")
    ...
    override func childContaining(_ source: UIStoryboardUnwindSegueSource) -> UIViewController? {
        print("∆∆ TestSubVC_SubVC2 childContaining")
        return super.childContaining(source)
    }

    override func unwind(for unwindSegue: UIStoryboardSegue, towards subsequentVC: UIViewController) {
        print("∆∆ TestSubVC_SubVC2 unwind")
    ...
    override func viewWillDisappear(_ animated: Bool) {
        print("∆∆ TestSubVC_SubVC2 viewWillDisappear")
        super.viewWillDisappear(animated)
    }
    
    //MARK: 顺序10，VC的view已经从图层中移除完毕时，回调该方法。该方法的调用与VC的父子关系是独立的，即VC的层次关系不影响该方法的回调。
    override func viewDidDisappear(_ animated: Bool) {
        print("∆∆ TestSubVC_SubVC2 viewDidDisappear")
        super.viewDidDisappear(animated)
    }

    override func didReceiveMemoryWarning(){
        print("∆∆ TestSubVC_SubVC2 didReceiveMemoryWarning")
