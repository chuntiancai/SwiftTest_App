...
class TestUICollectionViewLayout_VC: UIViewController {
    ...
    private var collViewDataSource=TestCollViewDataSource()
    private var flowLayout:TestUICollectionViewFlowLayout! //流布局对象
...
extension TestUICollectionViewLayout_VC{
    ...
    /// TODO: 初始化你要测试的view
    func initTestViewUI(){
        flowLayout = TestUICollectionViewFlowLayout()   //流布局
        flowCollView = UICollectionView(frame: CGRect.init(x: 8, y: 215, width: 400, height: 300), collectionViewLayout: flowLayout)
        ...
        flowCollView.backgroundColor = UIColor.white
