...
class TestAssembly_VC: UIViewController {
...
extension TestAssembly_VC: UICollectionViewDataSource {
    
    ///点击了cell
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        print("TestAssembly_VC 点击了第\(indexPath.row)个item")
...
extension TestAssembly_VC: UICollectionViewDelegate {
